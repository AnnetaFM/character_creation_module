"""File with graphic and functions about RPG game."""
...
def attack(char_name: str, char_class: str) -> str:
    """Показывает урон, нанесенный врагам."""
...
def special(char_name: str, char_class: str) -> str:
    """Позволяет понять, использовал ли пользователь специальные умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Позволяет пользователю ознакомиться справилами игры."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Позволяет пользователю выбрать персонажа."""
